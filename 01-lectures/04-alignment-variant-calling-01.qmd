...
Sonra klasörlerimiz oluşturalım:
...
ilk olarak bu betiği çalıştıralım:

```bash
sbatch scripts/quality-control-and-cutadapt.sh
```
...
Burada bahsedilen adımların hepsi betikte bulunmaktadır. Bu yüzden biz çalıştırmayalım.
